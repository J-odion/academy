...
const Intermediate: NextPageWithLayout = () => {
  ...
  const displayIntermediate = categories.filter((category) => category.category === 'intermediate');
  const currentItems = displayIntermediate.slice(indexOfFirstItem, indexOfLastItem);
  ...
  return (
    <DashboardSidebar>
      <div className="w-full mt-20 md:mt-20">
        ...
        <CurriculumHeaderTab currentTab="intermediate" />
      ...
      <Datapagination
        totalItems={displayIntermediate.length}
