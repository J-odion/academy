...
const Curriculum: NextPageWithLayout = () => {
  ...
  const displayBeginner = categories.filter((category) => category.category === 'beginner');
  const currentItems = displayBeginner.slice(indexOfFirstItem, indexOfLastItem);
  ...
  return (
    <DashboardSidebar>
      ...
      <Datapagination
        totalItems={displayBeginner.length}
