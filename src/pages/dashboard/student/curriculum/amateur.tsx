...
const Amateur: NextPageWithLayout = () => {
  ...
  const displayAmateur = categories.filter((category) => category.category === 'amateur');
  const currentItems = displayAmateur.slice(indexOfFirstItem, indexOfLastItem);
  ...
  return (
    <DashboardSidebar>
      <div className="w-full mt-20 md:mt-20">
        ...
        <CurriculumHeaderTab currentTab="amateur" />
      ...
      <Datapagination
        totalItems={displayAmateur.length}
