...
type ShopperCoursesModalProps = {
  className?: string;
  title: string;
  open: boolean;
  updateShopperCourse: any;
  shopperCourse: any;
...
const EditModal = ({
  ...
  useEffect(() => {
    if (shopperCourse) {
      setValue("courseTitle", shopperCourse.courseTitle);
      setValue("courseOrder", shopperCourse.courseOrder);
      setValue("videoLink", shopperCourse.videoLink);
      setValue("description", shopperCourse.description);
      setValue("assignmentQuestion1", shopperCourse.assignmentQuestion1);
      setValue("assignmentQuestion2", shopperCourse.assignmentQuestion2);
      setValue("assignmentQuestion3", shopperCourse.assignmentQuestion3);
      setValue("tablature", shopperCourse.tablature);
      setValue("videoThumbail", shopperCourse.videoThumbnail)
      setValue("audio", shopperCourse.audio);
      setValue("loop", shopperCourse.loop);
    }
  }, [shopperCourse, setValue]);
  ...
  const onSubmitStep2 = async (data: any) => {
    ...
    try {
      const response = await updateShopperCourse(formData);
                ...
                <>
                  <div className="mb-3 grid w-full items-center gap-1.5">
                    ...
                    <Input
                      ...
                      id="courseTitle"
                      defaultValue={shopperCourse?.courseTitle}
                  ...
                  <div className="mb-3 grid w-full items-center gap-1.5">
                    ...
                    <Input
                      ...
                      className="py-5 bg-[#F2E9DF] outline-none focus:ring-0 focus:ring-offset-0 focus:ring-offset-[#F2E9DF] focus:ring-[#A85334]"
                      id="courseOrder"
                      defaultValue={shopperCourse?.courseOrder}
                  ...
                  <div className="mb-3 grid w-full items-center gap-1.5">
                    ...
                    <Input
                      ...
                      className="py-5 bg-[#F2E9DF] outline-none focus:ring-0 focus:ring-offset-0 focus:ring-offset-[#F2E9DF] focus:ring-[#A85334]"
                      id="videoLink"
                      defaultValue={shopperCourse?.videoLink}
                      {...register("videoLink")}
                      disabled={isLoading}
                    />
                  </div>
                  <div className="mb-3 grid w-full items-center gap-1.5">
                    ...
                    <Textarea
                      className="py-5 bg-[#F2E9DF] outline-none focus:ring-0 focus:ring-offset-0 focus:ring-offset-[#F2E9DF] focus:ring-[#A85334]"
                      id="description"
                      defaultValue={shopperCourse.description}
                      disabled={isLoading}
                    />
                  </div>
                ...
                <>
                  <div className="mb-3 grid w-full items-center gap-1.5">
                    ...
                    <Textarea
                      ...
                      defaultValue={shopperCourse?.assignmentQuestion1}
                      disabled={isLoading}
                    />
                  </div>
                  <div className="mb-3 grid w-full items-center gap-1.5">
                    ...
                    <Textarea
                      ...
                      defaultValue={shopperCourse?.assignmentQuestion2}
                      disabled={isLoading}
                    />
                  </div>
                  <div className="mb-3 grid w-full items-center gap-1.5">
                    ...
                    <Textarea
                      ...
                      defaultValue={shopperCourse?.assignmentQuestion3}
                      disabled={isLoading}
                    />
                  </div>
                </>
